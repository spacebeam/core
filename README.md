...
It can download and launch [SSCAIT](http://sscaitournament.com/) 32bit C++ and Java bots and native 64bit Linux bots that use BWAPI `4.1.2, 4.2.0, 4.4.0` to communicate with the game.
